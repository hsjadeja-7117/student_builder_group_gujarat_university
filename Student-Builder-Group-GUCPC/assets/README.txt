...
------------------------------------------------
js/main.js currently renders the placeholder box for every team and
event card. Once you're ready to wire up real photos there too, open
js/main.js and swap this line in each card template:
